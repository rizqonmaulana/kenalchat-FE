  ...
  <div>
    <div class="card-room pt-3">
      ...
      <div v-if="profile !== 1" class="contact-list" style="margin-top: -50px;">
        ...
        <!-- invite friend modal-->
        <b-modal id="addFriendMobile" hide-header hide-footer>
          <div class="p-3">
            <h5 class="text-blue">
              Add friend
            </h5>
        ...
        <!-- contact modal -->
        <b-modal id="contactMobile" size="xl" hide-header hide-footer>
          <div class="p-3">
